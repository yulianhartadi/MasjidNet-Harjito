package com.rawzadigital.masjidnet.data;
...
import com.rawzadigital.masjidnet.model.CardViewImg;
import com.rawzadigital.masjidnet.model.Image;
import com.rawzadigital.masjidnet.model.Inbox;
import com.rawzadigital.masjidnet.model.MusicAlbum;
import com.rawzadigital.masjidnet.model.MusicSong;
import com.rawzadigital.masjidnet.model.People;
import com.rawzadigital.masjidnet.model.ShopCategory;
import com.rawzadigital.masjidnet.model.ShopProduct;
import com.rawzadigital.masjidnet.model.Social;
import com.rawzadigital.masjidnet.utils.MaterialColor;
...
public class DataGenerator {
    ...
    public static List<String> getStringsJarak(Context ctx) {
        List<String> items = new ArrayList<>();
        String arr[] = ctx.getResources().getStringArray(R.array.jarak);
        for (String s : arr) items.add(s);
        Collections.shuffle(items);
        return items;
    }
