...
public class FragmentTabsArtikel extends Fragment {
    public FragmentTabsArtikel() {
    }

    public static FragmentTabsArtikel newInstance() {
        FragmentTabsArtikel fragment = new FragmentTabsArtikel();
        return fragment;
    }
