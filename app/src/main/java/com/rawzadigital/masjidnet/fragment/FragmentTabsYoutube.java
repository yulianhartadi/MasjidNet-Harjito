...
public class FragmentTabsYoutube extends Fragment {
    public FragmentTabsYoutube() {
    }

    public static FragmentTabsYoutube newInstance() {
        FragmentTabsYoutube fragment = new FragmentTabsYoutube();
        return fragment;
    }
