...
public class ExternalDbOpenHelper extends SQLiteOpenHelper {
    ...
    //This piece of code will create a com.rawzadigital.masjidnet.database if it’s not yet created
    public void createDataBase() {
        ...
        if (!dbExist) {
            ...
            try {
                ...
                throw new Error("Error copying com.rawzadigital.masjidnet.database!");
            }
        } else {
